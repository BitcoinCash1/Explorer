...
class DatabaseMigration {
  ...
  private async $createMissingTablesAndIndexes(databaseSchemaVersion: number) {
    ...
    if (databaseSchemaVersion < 45 && isBitcoin === true) {
      ...
      await this.$executeQuery('ALTER TABLE `blocks` CHANGE `tx_count` `tx_count` INT UNSIGNED NOT NULL DEFAULT \'0\'');
      await this.$executeQuery('ALTER TABLE `statistics` RENAME COLUMN `vbytes_per_second` TO `bytes_per_second`');
      await this.$executeQuery('ALTER TABLE `statistics` RENAME COLUMN `vsize_1` TO `size_1`');
      await this.$executeQuery('ALTER TABLE `statistics` RENAME COLUMN `vsize_2` TO `size_2`');
      await this.$executeQuery('ALTER TABLE `statistics` RENAME COLUMN `vsize_3` TO `size_3`');
      await this.$executeQuery('ALTER TABLE `statistics` RENAME COLUMN `vsize_4` TO `size_4`');
      await this.$executeQuery('ALTER TABLE `statistics` RENAME COLUMN `vsize_5` TO `size_5`');
      await this.$executeQuery('ALTER TABLE `statistics` RENAME COLUMN `vsize_6` TO `size_6`');
      await this.$executeQuery('ALTER TABLE `statistics` RENAME COLUMN `vsize_8` TO `size_8`');
      await this.$executeQuery('ALTER TABLE `statistics` RENAME COLUMN `vsize_10` TO `size_10`');
      await this.$executeQuery('ALTER TABLE `statistics` RENAME COLUMN `vsize_12` TO `size_12`');
      await this.$executeQuery('ALTER TABLE `statistics` RENAME COLUMN `vsize_15` TO `size_15`');
      await this.$executeQuery('ALTER TABLE `statistics` RENAME COLUMN `vsize_20` TO `size_20`');
      await this.$executeQuery('ALTER TABLE `statistics` RENAME COLUMN `vsize_30` TO `size_30`');
      await this.$executeQuery('ALTER TABLE `statistics` RENAME COLUMN `vsize_40` TO `size_40`');
      await this.$executeQuery('ALTER TABLE `statistics` RENAME COLUMN `vsize_50` TO `size_50`');
      await this.$executeQuery('ALTER TABLE `statistics` RENAME COLUMN `vsize_60` TO `size_60`');
      await this.$executeQuery('ALTER TABLE `statistics` RENAME COLUMN `vsize_70` TO `size_70`');
      await this.$executeQuery('ALTER TABLE `statistics` RENAME COLUMN `vsize_80` TO `size_80`');
      await this.$executeQuery('ALTER TABLE `statistics` RENAME COLUMN `vsize_90` TO `size_90`');
      await this.$executeQuery('ALTER TABLE `statistics` RENAME COLUMN `vsize_100` TO `size_100`');
      await this.$executeQuery('ALTER TABLE `statistics` RENAME COLUMN `vsize_125` TO `size_125`');
      await this.$executeQuery('ALTER TABLE `statistics` RENAME COLUMN `vsize_150` TO `size_150`');
      await this.$executeQuery('ALTER TABLE `statistics` RENAME COLUMN `vsize_175` TO `size_175`');
      await this.$executeQuery('ALTER TABLE `statistics` RENAME COLUMN `vsize_200` TO `size_200`');
      await this.$executeQuery('ALTER TABLE `statistics` RENAME COLUMN `vsize_250` TO `size_250`');
      await this.$executeQuery('ALTER TABLE `statistics` RENAME COLUMN `vsize_300` TO `size_300`');
      await this.$executeQuery('ALTER TABLE `statistics` RENAME COLUMN `vsize_350` TO `size_350`');
      await this.$executeQuery('ALTER TABLE `statistics` RENAME COLUMN `vsize_400` TO `size_400`');
      await this.$executeQuery('ALTER TABLE `statistics` RENAME COLUMN `vsize_500` TO `size_500`');
      await this.$executeQuery('ALTER TABLE `statistics` RENAME COLUMN `vsize_600` TO `size_600`');
      await this.$executeQuery('ALTER TABLE `statistics` RENAME COLUMN `vsize_700` TO `size_700`');
      await this.$executeQuery('ALTER TABLE `statistics` RENAME COLUMN `vsize_800` TO `size_800`');
      await this.$executeQuery('ALTER TABLE `statistics` RENAME COLUMN `vsize_900` TO `size_900`');
      await this.$executeQuery('ALTER TABLE `statistics` RENAME COLUMN `vsize_1000` TO `size_1000`');
      await this.$executeQuery('ALTER TABLE `statistics` RENAME COLUMN `vsize_1200` TO `size_1200`');
      await this.$executeQuery('ALTER TABLE `statistics` RENAME COLUMN `vsize_1400` TO `size_1400`');
      await this.$executeQuery('ALTER TABLE `statistics` RENAME COLUMN `vsize_1600` TO `size_1600`');
      await this.$executeQuery('ALTER TABLE `statistics` RENAME COLUMN `vsize_1800` TO `size_1800`');
      await this.$executeQuery('ALTER TABLE `statistics` RENAME COLUMN `vsize_2000` TO `size_2000`');
