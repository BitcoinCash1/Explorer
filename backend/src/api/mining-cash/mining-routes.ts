...
class MiningRoutes {
  public initRoutes(app: Application) {
    app
      ...
      // TODO: Rename to mining/blocks/sizes/:interval
      .get(config.MEMPOOL.API_URL_PREFIX + 'mining/blocks/sizes-weights/:interval', this.$getHistoricalBlockSize)
