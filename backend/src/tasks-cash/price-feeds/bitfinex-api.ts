...
class BitfinexApi implements PriceFeed {
  ...
  public url: string = 'https://api.bitfinex.com/v1/pubticker/BCHN:';
  public urlHist: string = 'https://api-pub.bitfinex.com/v2/candles/trade:{GRANULARITY}:tBCHN:{CURRENCY}/hist';
