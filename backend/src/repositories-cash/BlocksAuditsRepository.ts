...
import { BlockAudit, AuditScore } from '../mempool-bch.interfaces';
  ...
  public async $getBlockAudit(hash: string): Promise<any> {
    try {
      const [rows]: any[] = await DB.query(
        ...
        blocks.tx_count, transactions, template, missing_txs as missingTxs, added_txs as addedTxs, match_rate as matchRate
        FROM blocks_audits
