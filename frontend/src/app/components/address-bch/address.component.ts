...
import { Address, Transaction } from '../../interfaces-bch/electrs.interface';
...
import { AddressInformation } from '../../interfaces-bch/node-api.interface';

@Component({
  selector: 'app-address-bch',
  templateUrl: './address.component.html',
  styleUrls: ['./address.component.scss'],
})
export class AddressComponentBch implements OnInit, OnDestroy {
  network = '';
    ...
    this.mainSubscription = this.route.paramMap
      ...
      .pipe(
        ...
        switchMap((address) => {
          ...
          this.isLoadingAddress = false;
          this.isLoadingTransactions = true;
          return this.electrsApiService.getAddressTransactions$(
            address.address
          );
        }),
  ...
  loadMore() {
    ...
    this.electrsApiService
      .getAddressTransactionsFromHash$(
        this.address.address,
        this.lastTransactionTxId
      )
      .subscribe(
