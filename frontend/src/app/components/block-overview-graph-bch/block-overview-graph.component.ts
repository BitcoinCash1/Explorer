...
import { TransactionStripped } from '../../interfaces-bch/websocket.interface';
...
@Component({
  selector: 'app-block-overview-graph-bch',
  templateUrl: './block-overview-graph.component.html',
  styleUrls: ['./block-overview-graph.component.scss'],
})
export class BlockOverviewGraphComponentBch implements AfterViewInit, OnDestroy, OnChanges {
