...
import { MempoolBlockDelta, TransactionStripped } from '../../interfaces-bch/websocket.interface';
...
@Component({
  selector: 'app-mempool-block-overview-bch',
  templateUrl: './mempool-block-overview.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class MempoolBlockOverviewComponentBch implements OnInit, OnDestroy, OnChanges, AfterViewInit {
  @Input() index: number;
  @Output() txPreviewEvent = new EventEmitter<TransactionStripped | void>();

  @ViewChild('blockGraph') blockGraph: BlockOverviewGraphComponentBch;
