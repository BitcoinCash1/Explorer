...
import { CpfpInfo } from '../../interfaces-bch/node-api.interface';

@Component({
  selector: 'app-transaction-preview-bch',
  templateUrl: './transaction-preview.component.html',
  styleUrls: ['./transaction-preview.component.scss'],
})
export class TransactionPreviewComponentBch implements OnInit, OnDestroy {
  network = '';
  tx: Transaction;
  txId: string;
  isLoadingTx = true;
