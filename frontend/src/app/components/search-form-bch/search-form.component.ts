...
import { SearchResultsComponentBch } from './search-results/search-results.component';

@Component({
  selector: 'app-search-form-bch',
  templateUrl: './search-form.component.html',
  styleUrls: ['./search-form.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SearchFormComponentBch implements OnInit {
  network = '';
  assets: object = {};
  isSearching = false;
  ...
  @ViewChild('searchResults') searchResults: SearchResultsComponentBch;
