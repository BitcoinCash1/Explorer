          ...
          items.map((item: any, index: number) => {
            ...
            if (this.hoverIndexSerie === hoverActive) {
              progressPercentageText = `<div class="total-parcial-active">
                ...
                <span class="total-parcial-vbytes">
                  ${this.vbytesPipe.transform(totalParcial, 2, 'B', 'MB', false)}
                </span>
            ...
            itemFormatted.push(`<tr class="item ${activeItemClass}">
              ...
              <td class="total-progress-sum">
                <span>
                  ${this.vbytesPipe.transform(item.value[1], 2, 'B', 'MB', false)}
                </span>
              </td>
              <td class="total-progress-sum">
                <span>
                  ${this.vbytesPipe.transform(totalValueArray[index], 2, 'B', 'MB', false)}
                </span>
              </td>
