...
export class BlockAuditComponentBch
  implements OnInit, AfterViewInit, OnDestroy
{
  ...
  blockGraphProjected: QueryList<BlockOverviewGraphComponentBch>;
  @ViewChildren('blockGraphActual')
  blockGraphActual: QueryList<BlockOverviewGraphComponentBch>;
  ...
  ngOnInit(): void {
    ...
    this.auditSubscription = this.route.paramMap
      .pipe(
