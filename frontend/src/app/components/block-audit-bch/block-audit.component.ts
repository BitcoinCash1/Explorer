...
import { BlockAudit, TransactionStripped } from '../../interfaces-bch/node-api.interface';
...
export class BlockAuditComponentBch implements OnInit, AfterViewInit, OnDestroy {
  ...
  @ViewChildren('blockGraphProjected') blockGraphProjected: QueryList<BlockOverviewGraphComponentBch>;
  @ViewChildren('blockGraphActual') blockGraphActual: QueryList<BlockOverviewGraphComponentBch>;
