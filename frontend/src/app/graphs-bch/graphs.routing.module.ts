...
import { BlockSizesWeightsGraphComponentBch } from '../components/block-sizes-weights-graph-bch/block-sizes-weights-graph.component';
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            data: { networks: ['bitcoin'] },
            component: BlockSizesWeightsGraphComponentBch,
          },
          {
            path: '',
            redirectTo: 'mempool',
